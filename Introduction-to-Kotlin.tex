...
On Android, Kotlin offers helpful tools like lifecycleScope (from Jetpack\autoref{sec:jetpack}), which automatically cancels coroutines when their associated activity is destroyed. This helps prevent memory leaks and keeps the app running efficiently.
