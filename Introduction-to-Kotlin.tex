...
\subsection{Call Java in Kotlin}
  ...
  \subsubsection{Null safety with Java}
    Because Java dosent provide the concept of null safety, every object wich gets returned from Java code can be null, so working with Java objects with Kotlins strict null safety...
    - platform types
