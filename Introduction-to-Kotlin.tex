...
\subsection{Everything is an Object}
  ...
  This allows for a more consistent object-oriented programming style and eliminates the need for wrapper classes.
  ...
  \begin{lstlisting}[language=Kotlin,title={Kotlin direct usage of Int}]
    42.hashCode()
  \end{lstlisting}
  Furthermore, functions are also objects in Kotlin, allowing for higher-order functions and functional programming paradigms. This means that functions can be passed as arguments, returned from other functions, and assigned to variables.
