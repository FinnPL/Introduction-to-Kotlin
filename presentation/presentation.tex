...
\begin{frame}[fragile]{Zusammenfassung} %Der gesamten Präsentation
  ...
  \begin{itemize}
    \item Moderne Programmiersprache mit präziser Syntax und innovativen Features.\lstinline{ public static void main(String[] args) -> fun main()}
    \vspace{0.25cm}
    \item Verbesserte Klassenstrukturen und Null-Sicherheit. \lstinline{...! ...?}
    \item Nahtlose Interoperabilität mit Java \adjustbox{valign=B}{\includegraphics[height=3ex]{Java Logo.png}}
$\leftrightarrow$
\adjustbox{valign=B}{\includegraphics[height=3ex]{Kotlin Full Color Logo Mark RGB.png}}
    
    \item Multiplattform-Entwicklung (Android) \adjustbox{valign=B}{ \begin{tikzpicture}
